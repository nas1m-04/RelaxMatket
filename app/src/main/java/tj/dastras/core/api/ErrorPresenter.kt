 ...
 * [tj.dastras.ui.components.ErrorAlertDialogHost] observes [current] and renders the
 * shared [tj.dastras.ui.components.ErrorAlertDialog] — so the dialog UI is never duplicated
 * across screens.
 */
object ErrorPresenter {
    ...
    /** Reports an API error to be shown in the global [tj.dastras.ui.components.ErrorAlertDialog]. */
