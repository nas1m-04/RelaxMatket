...
object MockData {
    ...
    val categories = listOf(
        Category(1,  "Мясо",       "🥩", "#FFE5E5", 124),
        Category(2,  "Овощи",      "🥦", "#E5F5E5", 87),
        Category(3,  "Фрукты",     "🍎", "#FFF3E0", 63),
        Category(4,  "Молочные",   "🥛", "#E5F0FF", 95),
        Category(5,  "Напитки",    "🥤", "#EDE5FF", 78),
        Category(6,  "Химия",      "🧴", "#FFE5F5", 56),
        Category(7,  "Детские",    "🍼", "#FFF5E5", 43),
        Category(8,  "Хлеб",       "🍞", "#FFF9E5", 38),
    )
    ...
    val loyaltyLevels = listOf(
        LoyaltyLevel("Старт",   0,      4999,  1f,  0xFFC0C0C0L, listOf("1% кэшбэк бонусами", "Базовые скидки")),
        LoyaltyLevel("Серебро", 5000,   19999, 3f,  0xFF9E9E9EL, listOf("3% кэшбэк бонусами", "Скидки до 10%", "Приоритетная доставка")),
        LoyaltyLevel("Золото",  20000,  49999, 5f,  0xFFD4AF37L, listOf("5% кэшбэк бонусами", "Скидки до 20%", "Бесплатная доставка", "Эксклюзивные акции")),
        LoyaltyLevel("Платина", 50000,  99999, 7f,  0xFF5C6BC0L, listOf("7% кэшбэк бонусами", "Скидки до 30%", "Бесплатная доставка", "Персональный менеджер")),
        LoyaltyLevel("Элит",   100000, Int.MAX_VALUE, 10f, 0xFF0F172AL, listOf("10% кэшбэк бонусами", "Скидки до 40%", "VIP доставка", "Персональный менеджер", "Эксклюзивные товары")),
    )
    ...
    val notifications = listOf(
        Notification(1, "🎁 Бонус за покупку начислен",     "Вам начислено 350 бонусов за покупку на 1 687 TJS",   "Сегодня, 14:23", NotificationType.BONUS),
